...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
            ...
            <div>
                <label class="block text-gray-600 text-sm font-bold mb-2">Última Actualización</label>
        ...
        <div class="flex items-center justify-between mt-8 pt-6 border-t">
            <div class="space-x-2">
                <a href="{{ route('admin.users.edit', $user) }}" class="bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
                    Editar
                </a>
            ...
            <form action="{{ route('admin.users.destroy', $user) }}" method="POST" style="display:inline;" onclick="return confirm('¿Estás seguro de que deseas eliminar este usuario?')">
                @csrf
                @method('DELETE')
